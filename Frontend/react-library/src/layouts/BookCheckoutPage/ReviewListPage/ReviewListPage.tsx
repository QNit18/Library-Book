...
export const ReviewListPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviewsData = async () => {
            ...
            const reviewUrl: string = `https://library-book-production.up.railway.app/api/reviews/search/findByBookId?bookId=${bookId}&page=${currentPage - 1}&size=${reviewsPerPage}`;
